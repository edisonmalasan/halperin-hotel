    ...
    <div>
        ...
        <div>
          <div>
            <picture>
              ...
              <source
                ...
                srcSet="/images/dining/fountain-coffee/fountain-coffee-page.png"
              />

              <img
                className="w-full h-auto object-contain"
                src="/images/dining/fountain-coffee/fountain-coffee-page.png"
                alt="FOUNTAIN COFFEE ROOM"
              />
            </picture>
          </div>
          <div className="flex flex-col items-center justify-center gap-y-5 p-4 sm:p-6 md:p-10">
            ...
            <div className="text-2xl sm:text-3xl md:text-5xl font-extralight text-center">
              1950s-style counter service
            </div>
            <h1 className="text-base">THE FOUNTAIN COFFEE ROOM</h1>
            <p className="text-center max-w-lg text-sm sm:text-base font-light">
              The iconic diner has been serving Hollywood stars since 1949 and
              you still never know who you might find yourself eating a slice of
              apple pie next to.
            </p>
          </div>
        </div>
      ...
      <section className="w-full flex justify-center items-center bg-transparent pt-20 pb-10">
        ...
        >
          {/* Background image */}
          <img
            src="/images/dining/fountain-coffee/fountain-coffee-open.png"
        ...
        <div className="container mx-auto py-10">
          <div className="flex flex-row justify-center gap-x-100 overflow-hidden">
            ...
            <p className="max-w-sm text-[14px] pt-5 tracking-wide text-justify">
              Cocktails so good, they shouldn't just be for brunch. Enjoy a
              selection of featured wines and our classic spin on daytime
              favourites – such as the FCR Bloody Mary with house-spiced tomato
              juice or a sparkling Bellini.
            </p>
          </div>
        </div>
      </section>
