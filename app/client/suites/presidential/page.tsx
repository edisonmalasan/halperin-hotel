...
import { tabsData } from "../data/presidentialTabsData";
    ...
    <div>
        ...
        <div>
          <div>
            <picture>
              ...
              <source
                ...
                srcSet="/images/suites/presidential/presidential-page.png"
              />

              <img
                className="w-full h-auto object-contain"
                src="/images/suites/presidential/presidential-page.png"
          ...
          <div className="flex flex-col items-center justify-center gap-y-5 p-4 sm:p-6 md:p-10">
            ...
            <div className="text-2xl sm:text-3xl md:text-5xl font-extralight text-center">
              Breathtaking views over Halperin Hotel
            </div>
            <h1 className="text-base">PRESIDENTIAL SUITE</h1>
            <p className="text-center max-w-sm text-sm sm:text-base font-light">
              Rooms of sheer splendour, including a spacious living room and
              large balcony overlooking Beverly Hills. This truly beautiful
              suite also has a den, dining room and full kitchen for
              entertaining, in addition to a luxurious marble bathroom and
              powder room.
            </p>
          </div>
        </div>
      ...
      <section className="w-full flex justify-center items-center bg-transparent pt-20 pb-10">
        ...
        >
          {/* Background image */}
          <img
            src="/images/suites/presidential/presidential-open.png"
        ...
        <div className="container mx-auto">
          <div className="flex flex-row items-between justify-between mx-45 gap-25 overflow-hidden">
            <div className="flex flex-col justify-center gap-y-10 overflow-hidden max-w-4xl">
              <div className="text-[#8b6c26] text-sm">YOUR SUITE</div>
              <p className="text-3xl/10 indent-10 tracking-wide text-justify">
                Bathed in soft tones of peach, mauve, and sage, the suite
                features one king-size bed, a full vanity and dressing area, gas
                fireplace, a spacious living room with dining area and full
                kitchen, a den, marble bathroom with Jacuzzi tub and two
                showers.
              </p>
            </div>
      ...
      <section className="w-full max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="flex flex-row justify-between mb-10 text-center md:text-left">
          ...
          <p className="text-neutral-600 text-base max-w-2xl mx-auto md:mx-0">
            A most glorious suite full of wonderful furnishings, stylish warmth
            and lashings of cool elegance. Lord Snowdon and Princess Margaret
            often stayed here.
          </p>
        </div>
        {/* Bottom */}
        <div className="mx-auto w-full">
          {(() => {
            ...
            const room = suites.find((r) => r.href === "/suites/presidential");
