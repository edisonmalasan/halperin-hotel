...
import { tabsData } from "../data/premierTabsData";
import ImageCarousel from "../../components/ImageCarousel";
import { diningSlides } from "../../data/diningCarousel";
import { suites } from "../../data/suites";

export default function PremierSuitePage() {
  return (
    <div>
      {/* SECTION 1 */}
      <section>
        <div>
          <div>
            <picture>
              ...
              <source
                ...
                srcSet="/images/suites/premier/premier-page.png"
              />

              <img
                className="w-full h-auto object-contain"
                src="/images/suites/premier/premier-page.png"
                alt="Premier Suite with Patio"
              />
            </picture>
          </div>
          <div className="flex flex-col items-center justify-center gap-y-5 p-4 sm:p-6 md:p-10">
            ...
            <h1 className="text-base">PREMIER SUITE</h1>
            <p className="text-center max-w-sm text-sm sm:text-base font-light">
              More of a premier house than a premier suite, with large airy
              rooms, a full kitchen, dining area and the elegant patio for those
              sunny days and warm LA nights.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="w-full flex justify-center items-center bg-transparent pt-20 pb-10">
        ...
        >
          {/* Background image */}
          <img
            src="/images/suites/premier/premier-open.png"
          ...
          <div className="flex flex-row items-between justify-between mx-45 gap-25 overflow-hidden">
            <div className="flex flex-col justify-center gap-y-10 overflow-hidden max-w-4xl">
              ...
              <p className="text-3xl/10 indent-10 tracking-wide text-justify">
                A masterpiece in classic wood furnishings, with décor bathed in
                soft tones. The suite includes a large master bedroom and marble
                bathroom, spacious living room, full kitchen, fireplace, dining
                table and private patio... essentially, everything you could
                need.
              </p>
            </div>
      ...
      <section className="w-full max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="flex flex-row justify-between mb-10 text-center md:text-left">
          ...
          <p className="text-neutral-600 text-base max-w-2xl mx-auto md:mx-0">
            A sophisticated haven of stylish delight, creating a perfect home
        ...
        <div className="mx-auto w-full">
          {(() => {
            ...
            const room = suites.find((r) => r.href === "/suites/premier");
