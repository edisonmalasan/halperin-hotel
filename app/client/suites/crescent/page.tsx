...
import { tabsData } from "../data/crescentTabsData";
import ImageCarousel from "../../components/ImageCarousel";
import { diningSlides } from "../../data/diningCarousel";
import { suites } from "../../data/suites";

export default function CrescentSuitePage() {
  return (
    <div>
      {/* SECTION 1 */}
      <section>
        <div>
          <div>
            <picture>
              ...
              <source
                ...
                srcSet="/images/suites/crescent/crescent-page.png"
              />

              <img
                className="w-full h-auto object-contain"
                src="/images/suites/crescent/crescent-page.png"
                alt="Crescent Suite"
              />
            </picture>
          </div>
          <div className="flex flex-col items-center justify-center gap-y-5 p-4 sm:p-6 md:p-10">
            ...
            <div className="text-2xl sm:text-3xl md:text-5xl font-extralight text-center">
              The Halperin retreat
            </div>
            <h1 className="text-base">CRESCENT SUITE</h1>
            <p className="text-center max-w-sm text-sm sm:text-base font-light">
              Live in utter splendour surrounded by fine furnishings and an air
              of distinct Hollywood exclusivity. From your balcony the whole of
              Beverly Hills waits to entertain you.
            </p>
          </div>
        </div>
      </section>
      ...
      {/* SECTION 2 */}
      <section className="w-full flex justify-center items-center bg-transparent pt-20">
        <div
          className="relative w-full"
          style={{
            maxWidth: "1449px",
            aspectRatio: "1449 / 784",
            minHeight: "744 px",
          }}
        >
          {/* Background image */}
          <img
            src="/images/suites/crescent/crescent-open.png"
          ...
          <div className="flex flex-row items-between justify-between mx-45 gap-25 overflow-hidden">
            <div className="flex flex-col justify-center gap-y-10 overflow-hidden max-w-4xl">
              ...
              <p className="text-3xl/10 indent-10 tracking-wide text-justify">
                From the grand fireplace to the stylishly curved sofa, every
                detail has a touch of the truly magical.
              </p>
            </div>
      ...
      <section className="w-full max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="flex flex-row justify-between mb-10 text-center md:text-left">
          ...
          <p className="text-neutral-600 text-base max-w-2xl mx-auto md:mx-0">
            An elegantly modern twist on a classically LA style. Ideal for
            guests wanting to be close to the hotel’s lobby and legendary Polo
            Lounge.
          </p>
        </div>
        {/* Bottom */}
        <div className="mx-auto w-full">
          {(() => {
            ...
            const room = suites.find((r) => r.href === "/suites/crescent");
