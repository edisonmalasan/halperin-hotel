...
import { tabsData } from "../data/deluxeBalconyTabsData";
      ...
      <section>
        <div>
          ...
          <div className="flex flex-col items-center justify-center gap-y-5 p-4 sm:p-6 md:p-10">
            ...
            <h1 className="text-base">DELUXE ROOM WITH BALCONY</h1>
            <p className="text-center max-w-sm text-sm sm:text-base font-light">
              A peaceful space with everything you need. A luxurious example of
              modern Californian style overlooking the city or lush gardens.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-row items-between justify-between mx-45 gap-25 overflow-hidden">
            <div className="flex flex-col justify-center gap-y-10 overflow-hidden max-w-4xl">
              ...
              <p className="text-3xl/10 indent-10 tracking-wide text-justify">
                Comforting and spacious, these rooms are furnished with their
                own unique character, celebrating the hotel's famous pink and
                green motif and featuring views of Beverly Hills or our lush
                gardens from your private balcony.
              </p>
            </div>
