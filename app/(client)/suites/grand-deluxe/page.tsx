...
import { tabsData } from "../data/grandTabsData";
    ...
    <div>
      ...
      <section>
        <div>
          ...
          <div className="flex flex-col items-center justify-center gap-y-5 p-4 sm:p-6 md:p-10">
            ...
            <h1 className="text-base">GRAND DELUXE SUIT</h1>
            <p className="text-center max-w-sm text-sm sm:text-base font-light">
              A most glorious suite full of wonderful furnishings, stylish
              warmth and lashings of cool elegance. Your incredible bed and
              spacious patio will make it hard to leave.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="w-full flex justify-center items-center bg-transparent pt-20">
        ...
        >
          {/* Background image */}
          <img
            src="/images/suites/grand-deluxe/grand-deluxe-open.png"
          ...
          <div className="flex flex-row items-between justify-between mx-45 gap-25 overflow-hidden">
            <div className="flex flex-col justify-center gap-y-10 overflow-hidden max-w-4xl">
              ...
              <p className="text-3xl/10 indent-10 tracking-wide text-justify">
                The colours and layout of the Grand Deluxe Suite give it the
                heart of a laid-back residence with the personality of a
                superstar.
              </p>
            </div>
      ...
      <section className="w-full max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="mx-auto w-full">
          {(() => {
            ...
            const room = suites.find((r) => r.href === "/suites/grand-deluxe");
