...
import { tabsData } from "../data/rodeoTabsData";
    ...
    <div>
      ...
      <section>
        <div>
          <div>
            <picture>
              ...
              <source
                ...
                srcSet="/images/suites/rodeo/rodeo-page.png"
              />
          ...
          <div className="flex flex-col items-center justify-center gap-y-5 p-4 sm:p-6 md:p-10">
            ...
            <h1 className="text-base">RODEO SUITE</h1>
            <p className="text-center max-w-sm text-sm sm:text-base font-light">
              The epitome of ‘Pink Palace’ attitude and a wonderful suite in
              which to truly feel part of our history, style and culture. Plenty
              of room for entertaining or having your own, luxurious LA moment.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="w-full flex justify-center items-center bg-transparent pt-20 pb-10">
        ...
        >
          {/* Background image */}
          <img
            src="/images/suites/rodeo/rodeo-open.png"
          ...
          <div className="flex flex-row items-between justify-between mx-45 gap-25 overflow-hidden">
            <div className="flex flex-col justify-center gap-y-10 overflow-hidden max-w-4xl">
              ...
              <p className="text-3xl/10 indent-10 tracking-wide text-justify">
                The much sought-after features include a separate living room
                and primary bedroom, marble bathrooms, a guest powder room, and
      ...
      <section className="w-full max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="flex flex-row justify-between mb-10 text-center md:text-left">
          ...
          <p className="text-neutral-600 text-base max-w-2xl mx-auto md:mx-0">
            The Rodeo Suite faces Sunset Boulevard, with fantastic 180-degree
            views including Century City and Beverly Hills.
          </p>
        </div>
        {/* Bottom */}
