...
import { tabsData } from "../data/juniorPatioTabsData";
    ...
    <div>
        ...
        <div>
          <div>
            <picture>
              ...
              <source
                ...
                srcSet="/images/suites/junior-patio/junior-patio-page.png"
              />

              <img
                className="w-full h-auto object-contain"
                src="/images/suites/junior-patio/junior-patio-page.png"
                alt="Junior Patio Suite at The Halperin Hotel"
              />
            </picture>
          </div>
          <div className="flex flex-col items-center justify-center gap-y-5 p-4 sm:p-6 md:p-10">
            ...
            <div className="text-2xl sm:text-3xl md:text-5xl font-extralight text-center">
              The beauty of nature on your terrace
            </div>
            <h1 className="text-base">JUNIOR SUITE WITH PATIO</h1>
            <p className="text-center max-w-sm text-sm sm:text-base font-light">
              Beyond the pleasure of your gloriously spacious suite awaits your
              patio. Soak in the famous LA sunshine and celebrated history that
              surrounds you.
            </p>
          </div>
        </div>
      ...
      <section className="w-full flex justify-center items-center bg-transparent pt-20">
        ...
        >
          {/* Background image */}
          <img
            src="/images/suites/junior/junior-open.png"
          ...
          <div className="flex flex-row items-between justify-between mx-45 gap-25 overflow-hidden">
            <div className="flex flex-col justify-center gap-y-10 overflow-hidden max-w-4xl">
              ...
              <p className="text-3xl/10 indent-10 tracking-wide text-justify">
                There's just something about The Halperin Hotel air that makes
                you crave a suite with its own outside space, so that you can
                enjoy a true experience of life in this sunny wonderland.
              </p>
            </div>
      ...
      <section className="w-full max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="flex flex-row justify-between mb-10 text-center md:text-left">
          ...
          <p className="text-neutral-600 text-base max-w-2xl mx-auto md:mx-0">
            Beyond the pleasure of your gloriously spacious suite awaits your
            patio and private outdoor living space.
          </p>
        </div>
        {/* Bottom */}
        <div className="mx-auto w-full">
          {(() => {
            ...
            const room = suites.find((r) => r.href === "/suites/junior-patio");
