...
import { tabsData } from "../data/deluxePatioTabsData";
import ImageCarousel from "../../components/ImageCarousel";
import { diningSlides } from "../../data/diningCarousel";
import { rooms } from "../../data/rooms";

export default function DeluxePatioRoomPage() {
  return (
    <div>
      {/* SECTION 1 */}
      <section>
        <div>
          <div>
            <picture>
              ...
              <source
                ...
                srcSet="/images/rooms/deluxe-balcony/deluxe-balcony-page.png"
              />
          ...
          <div className="flex flex-col items-center justify-center gap-y-5 p-4 sm:p-6 md:p-10">
            ...
            <h1 className="text-base">DELUXE ROOM WITH PATIO</h1>
            <p className="text-center max-w-sm text-sm sm:text-base font-light">
              When your room is surrounded by lush, tropical gardens, a private
              patio feels like the most wonderful way to enjoy it. This is a
              bright, serene space dazzling with effortless Californian style
              and modern luxury.
            </p>
          </div>
        </div>
          ...
          <div className="flex flex-row items-between justify-between mx-45 gap-25 overflow-hidden">
            <div className="flex flex-col justify-center gap-y-10 overflow-hidden max-w-4xl">
              ...
              <p className="text-3xl/10 indent-10 tracking-wide text-justify">
                Well, it would be wrong to stay at The Beverly Hills Hotel and
                not have your very own patio, wouldn't it?
              </p>
            </div>
      ...
      <section className="w-full max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="mx-auto w-full">
          {(() => {
            ...
            const room = rooms.find((r) => r.href === "/rooms/deluxe-patio");
