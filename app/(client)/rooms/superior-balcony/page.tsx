      ...
      <section>
        <div>
          <div>
            <picture>
              ...
              <source
                ...
                srcSet="/images/rooms/superior-balcony/superior-room-balcony-page.png"
              />

              <img
                className="w-full h-auto object-contain"
                src="/images/rooms/superior-balcony/superior-room-balcony-page.png"
          ...
          <div className="flex flex-col items-center justify-center gap-y-5 p-4 sm:p-6 md:p-10">
            ...
            <h1 className="text-base">SUPERIOR ROOM WITH BALCONY</h1>
            <p className="text-center max-w-sm text-sm sm:text-base font-light">
              Enjoy lovely garden views from these light and airy rooms and your
              very own balcony. Here, in the centre of the hotel, Old Hollywood
              glamour blends with a warm, contemporary style.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-row items-between justify-between mx-45 gap-25 overflow-hidden">
            <div className="flex flex-col justify-center gap-y-10 overflow-hidden max-w-4xl">
              ...
              <p className="text-3xl/10 indent-10 tracking-wide text-justify">
                Elevate your stay from stylish to superb with a bit of LA
                sunshine. Your balcony brings the freshness of fragrant gardens
