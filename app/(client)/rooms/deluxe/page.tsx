...
import { tabsData } from "../data/deluxeTabsData";
      ...
      <section>
        <div>
          <div>
            <picture>
              ...
              <source
                ...
                srcSet="/images/rooms/deluxe/deluxe-page.png"
              />

              <img
                className="w-full h-auto object-contain"
                src="/images/rooms/deluxe/deluxe-page.png"
                alt="Deluxe Room"
              />
            </picture>
          </div>
          <div className="flex flex-col items-center justify-center gap-y-5 p-4 sm:p-6 md:p-10">
            ...
            <h1 className="text-base">DELUXE ROOM</h1>
            <p className="text-center max-w-sm text-sm sm:text-base font-light">
              An elegantly modern twist on a classically LA style. These are
              wonderfully peaceful and private rooms with plenty of comfortable
              space.
            </p>
          </div>
        </div>
          ...
          <div className="flex flex-row items-between justify-between mx-45 gap-25 overflow-hidden">
            <div className="flex flex-col justify-center gap-y-10 overflow-hidden max-w-4xl">
              ...
              <p className="text-3xl/10 indent-10 tracking-wide text-justify">
                Everything you need for a wonderful stay. Ideal for guests
                wanting to be close to the hotel’s lobby and legendary Polo
                Lounge.
              </p>
            </div>
      ...
      <section className="w-full max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="mx-auto w-full">
          {(() => {
            ...
            const room = rooms.find((r) => r.href === "/rooms/deluxe");
