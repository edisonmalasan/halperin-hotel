...
import { tabsData } from "../data/bungalowStudioTabsData";
        ...
        <div>
          <div>
            <picture>
              ...
              <source
                ...
                srcSet="/images/rooms/bungalow-studio-balcony/bungalow-studio-balcony-page.png"
              />

              <img
                className="w-full h-auto object-contain"
                src="/images/rooms/bungalow-studio-balcony/bungalow-studio-balcony-page.png"
          ...
          <div className="flex flex-col items-center justify-center gap-y-5 p-4 sm:p-6 md:p-10">
            ...
            <div className="text-2xl sm:text-3xl md:text-5xl font-extralight text-center">
              A private bungalow retreat
            </div>
            <h1 className="text-base">BUNGALOW STUDIO WITH BALCONY</h1>
            <p className="text-center max-w-lg text-sm sm:text-base font-light">
              Our iconic bungalow studios are dotted along the winding pathways
              of the tranquil gardens. Within, you'll find a spacious king
              bedded studio, designer linens, a marble bath and a private
              balcony on which to enjoy the leafy surroundings. This is where
          ...
          <div className="flex flex-row items-between justify-between mx-45 gap-25 overflow-hidden">
            <div className="flex flex-col justify-center gap-y-10 overflow-hidden max-w-4xl">
              ...
              <p className="text-3xl/10 indent-10 tracking-wide text-justify">
                Bathed in soft colours and the glow of history, this is a place
                to unwind and experience the joyous charm of bungalow living. As
                well as providing a spacious sitting area, these studios offer a
                balcony from which to enjoy the tropical surroundings.
              </p>
            </div>
