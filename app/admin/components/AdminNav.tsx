...
import { Home, CalendarCheck, BedDouble, Brush, Users, Receipt, BarChart2, Settings } from "lucide-react";
...
export default function AdminNav() {
  ...
  return (
    <nav className="w-full md:w-64 bg-white border-r border-[#8b6c26] min-h-screen flex flex-col py-6 px-2 md:px-4">
      <div className="mb-8 text-2xl font-bold text-[#8b6c26] text-center">PMS Admin</div>
